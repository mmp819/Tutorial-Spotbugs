...
public class CuentaRepeticionesEficiente {
	 ...
	 */
	public CuentaRepeticionesEficiente(String nomFich) throws FileNotFoundException, IOException {
		Locale.setDefault(new Locale("ES"));
		String str = "";
		try (Scanner in = new Scanner(new File(nomFich), Charset.forName("UTF-8"))) {
			while (in.hasNext()) {
				str = in.next();
